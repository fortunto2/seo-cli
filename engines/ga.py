...
def get_overview(sa_file: str, property_id: str, days: int = 28) -> dict:
...
def get_top_pages(sa_file: str, property_id: str, days: int = 28, limit: int = 15) -> list[dict]:
...
def get_channels(sa_file: str, property_id: str, days: int = 28) -> list[dict]:
...
def get_countries(sa_file: str, property_id: str, days: int = 28, limit: int = 10) -> list[dict]:
...
def get_sources(sa_file: str, property_id: str, days: int = 28, limit: int = 10) -> list[dict]:
...
def get_daily(sa_file: str, property_id: str, days: int = 28) -> list[dict]:
